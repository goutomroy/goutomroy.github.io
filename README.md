...
## goutom.sust.cse@gmail.com | +88 01711664606
...
## ACM (Association for Computing Machinery) programming
...
personally. I attended in NCPC (National Computer Programming Contest)and
```
### ICPC (International Computer Programming Contest) on behalf of Shahjalal

### University of Science and Technology with my team in 2008.
...
```
WorkJapan A job seeking application for foreigners in Japan. I wrote
whole application.
```
### Smart Home
...
BLE based devices.
```
## Car Inventory for An android app scans cars barcode/qr-code when arrive

```
first in the vault to sell. After scanning , it hits a third party
```

### carvision api for its complete mechanical information to store data in

```
server so that later they can show it to customer by
searching.Here I used Snapdragon Face recognization sdk.
Employee
Timing/salary tracker
...
GoFresh An ecommerce application for Bangladesh. I wrote whole
application.
```
### Forgive for Good Learning how to forgive by Dr. Fred Luskin. I wrote whole
...
WorkJapan A job seeking application for foreigners in
...
FCM, gunicorn, ec
```
## Car Inventory for carvision An android app scans cars barcode/qr-code
...
```
Employee Timing/salary tracker
with face recognition/detection
...
framework, postgresql, nginx, gunicorn, ec
```
GoFresh - an ecommerce
application to connect all the
super shop of Bangladesh.
...
ANKUR ICT DEVELOPMENT FOUNDATION As a python developer.
January 2010 to September 2012 – 2
year 10 months.

SurroundApps Inc. Ltd. As a python developer.
November 2012 to February 2014 – 1
year 4 months

### AplombTech BD As a Android developer.

### January 2016 to June 2017 – 1 year 6
...
```
As lead android developer as well as
